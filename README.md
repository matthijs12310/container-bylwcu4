...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bylwcu4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bylwcu4.containers.anotherwebservice.com/
...
```
git clone git@github.com:matthijs12310/container-bylwcu4.git
cd container-bylwcu4
```
...
```
docker attach container-bylwcu4
```
